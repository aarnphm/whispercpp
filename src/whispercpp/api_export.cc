...
PYBIND11_MODULE(api, m) {
    ...
    py::class_<SamplingStrategies>(m, "SamplingStrategies",
        ...
        .def_static("from_strategy_type",
                    &SamplingStrategies::from_strategy_type, "strategy"_a)
        .def_property(
            "type", [](SamplingStrategies &self) { return self.type; },
            [](SamplingStrategies &self,
               SamplingStrategies::StrategyType type) { self.type = type; })
        .def_property(
    ...
    py::class_<Params>(m, "Params", "Whisper parameters container")
        ...
        .def_property("offset_ms", &Params::get_offset_ms,
                      &Params::set_offset_ms)
        .def_property("duration_ms", &Params::get_duration_ms,
                      &Params::set_duration_ms)
        .def_property("translate", &Params::get_translate,
        ...
        .def_property("audio_ctx", &Params::get_audio_ctx,
